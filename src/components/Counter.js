...
STEP 1:
  ...
  The 'count' state should be initialized to the number zero. done
*/
/*
STEP 2:
...
STEP 4:
  ...
  reassign a const, React would not be aware anything changed. Always use the state updater, passing in a new value. done
*/
/*
STEP 5:
  This click handler needs to use 'setCount' to set the 'count' to be the current 'count' minus one.
  Do NOT do count--. That amounts to trying to mutate 'count' in place. This is the road to perdition. done 
*/
/*
STEP 6:
  This click handler needs to use 'setCount' to set the 'count' to be zero again. done
*/
